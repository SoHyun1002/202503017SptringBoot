...
<body>
    <div class="container">
        ...
        <div class="user-details">
            ...
            <p><strong>상세 정보:</strong> ${userDetails}</p>
            <p><strong>가입일:</strong> 2023-01-01</p>
            <p><strong>이메일:</strong> user${userId}@example.com</p>
            <p><strong>상태:</strong> 활성</p>
        </div>
        
        <div class="links">
            <a href="<c:url value='/users/${userId}'/>">기본 정보로</a>
