...
<body>
    <div class="container">
        <h1>Spring Boot AOP 예제</h1>
        <p>이 프로젝트는 Spring Boot에서 AOP(Aspect-Oriented Programming)를 학습하기 위한 예제 프로젝트입니다.</p>
        
        <h2>사용 가능한 페이지:</h2>
        <ul>
            <li><a href="<c:url value='/users/'/>">사용자 목록</a></li>
            <li><a href="<c:url value='/users/1'/>">사용자 정보 (ID: 1)</a></li>
            <li><a href="<c:url value='/users/1/details'/>">사용자 상세 정보 (ID: 1)</a></li>
        </ul>
        
        <h2>AOP 설명</h2>
        <p>이 프로젝트에서는 다음과 같은 AOP 기능을 구현했습니다:</p>
        <ul>
            <li>서비스 계층의 모든 메서드 실행 시간 측정</li>
            <li>메서드 실행 전/후 로깅</li>
        </ul>
        <p>콘솔 로그를 확인하여 AOP가 적용된 결과를 볼 수 있습니다.</p>
        
        <div class="links">
            <a href="<c:url value='/aop/explain'/>" class="highlight-link">AOP 작동방식 도식화 설명 보기</a>
        </div>
