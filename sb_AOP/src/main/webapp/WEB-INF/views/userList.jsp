...
<body>
    <div class="container">
        ...
        <div class="user-list">
            <div class="user-item">
                <a href="<c:url value='/users/1'/>">사용자 ID: 1</a>
            </div>
            <div class="user-item">
                <a href="<c:url value='/users/2'/>">사용자 ID: 2</a>
            </div>
            <div class="user-item">
                <a href="<c:url value='/users/3'/>">사용자 ID: 3</a>
            </div>
        </div>
        
        <div class="links">
            <a href="<c:url value='/users/home'/>" class="back-link">홈으로 돌아가기</a>
            <a href="<c:url value='/aop/explain'/>" class="back-link">AOP 작동방식 보기</a>
        </div>
